...
import { Tabs, TabItem } from '@deramond.dev/astro';
...
1. **It is time to start writing your README**.
    ...
    Click on the _Preview_ tab to see how your README will look once it's published.
    </Aside>
...
1. **Audit your current README**
    ...
    <Steps>
        ...
        1. **Think about other sections that would be relevant** to your project and add them as needed. For instance:
        ...
        1. **Link everything from your README**. For example, consider adding links to:
